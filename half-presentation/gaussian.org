...
#+BEGIN_SRC ipython :session :results raw drawer :exports none :eval no-export
  ...
  plt.plot(n, norm.pdf(n, mu, sigma), 'k-')
  plt.plot(n, likelihood(n, mu+0.6, sigma), 'k--')
  n = np.arange(a, b+0.01, 0.1)
  plt.plot(n, likelihood(n, mu+0.6, sigma), 'k-')
  plt.fill_between(n, norm.pdf(n, mu, sigma), likelihood(n, mu+0.6, sigma), color='r', alpha=0.8)
  plt.fill_between(n, 0, norm.pdf(n, mu, sigma), alpha=0.5)
  plt.plot([b, b], [0, 1], 'k-')
  plt.text(b, -0.08, 'b', ha='center', va='center', size=20, color='k')
  plt.text(a, -0.08, 'a', ha='center', va='center', size=20, color='k')
  plt.plot([a, a], [0, 1], 'k-')
  ...
  plt.savefig('gaussian_shift.pdf')
#+END_SRC

#+RESULTS:
:RESULTS:
# Out[1]:
[[file:./obipy-resources/OxJoh0.png]]
:END:
