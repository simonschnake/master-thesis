...
:RESULTS:
# Out[3]:
[[file:./obipy-resources/u0esu7.png]]
:END:
...
:RESULTS:
# Out[4]:
[[file:./obipy-resources/aM7u7c.png]]
:END:
...
:RESULTS:
# Out[59]:
[[file:./obipy-resources/1E6JEU.png]]
:END:
...
[[file:./obipy-resources/BiFYq0.png]]
:END:
...
#+BEGIN_SRC ipython :session :results raw drawer :exports none :eval no-export
  ...
  out = optimize.minimize(mse, np.array(c_fit), method='L-BFGS-B')
  c_mse = out['x']

  out = optimize.minimize(mwse, np.array(c_fit), method='L-BFGS-B')
  c_mwse = out['x']
...
:RESULTS:
# Out[65]:
[[file:./obipy-resources/gfPb1o.png]]
:END:
