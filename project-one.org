...
:RESULTS:
# Out[10]:
[[file:./obipy-resources/CeqrFM.png]]
:END:
...
:RESULTS:
# Out[11]:
[[file:./obipy-resources/snjKS4.png]]
:END:
...
:RESULTS:
# Out[12]:
[[file:./obipy-resources/6u0krF.png]]
:END:
#+
...
[[file:./obipy-resources/TI4qcH.png]]
:END:
...
:RESULTS:
# Out[14]:
[[file:./obipy-resources/WlrSDU.png]]
:END:
...
:RESULTS:
# Out[16]:
[[file:./obipy-resources/ziOUMO.png]]
:END:
...
#+BEGIN_SRC ipython :session :results raw drawer :exports none :eval no-export
  ...
  results = D.predict_generator(DataGenerator(X_test, Y_test,
					      batch_size=128,
					      data_augment=False))
  plt.plot(Y_test[:10000], (results[:10000]+1)*np.array(Y_test[:10000], dtype=np.float32), 'k.', alpha=0.25, markersize=3)
