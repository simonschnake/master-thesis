...
#+BEGIN_SRC jupyter-python :async "yes" :session "py" :results raw drawer :exports none :eval no-export
  ...
  plt.text(75, 0.03, r'$2\pm \Delta 0.1$ GeV', color='blue', size=13)
  plt.text(250, 0.015, r'$8\pm \Delta 0.1$ GeV', color='red', size=13)
  # plt.xlim([0., 10.])
  # plt.ylim([0., 0.01])
...
#+RESULTS:
:RESULTS:
[[file:./.ob-jupyter/376ee575b089d638e282e9f4a010e8d44c2beb59.png]]
:END:
...
#+BEGIN_SRC jupyter-python :async "yes" :session "py" :results raw drawer :exports none :eval no-export
  ...
  plt.text(4, 0.3, r'$2\pm \Delta 0.1$ GeV', color='blue', size=13)
  plt.text(5, 0.15, r'$8\pm \Delta 0.1$ GeV', color='red', size=13)
  # plt.xlim([0., 10.])
  # plt.ylim([0., 0.01])
...
#+RESULTS:
:RESULTS:
[[file:./.ob-jupyter/b44c3460d5c411f4dc80580c2a09c2fc8488cac1.png]]
:END:
...
#+BEGIN_SRC jupyter-python :async "yes" :session "py" :results raw drawer :exports none :eval no-export
  ...
  plt.text(4.5, 0.3, r'$2\pm \Delta 0.1$ GeV', color='blue', size=13)
  plt.text(4.5, 0.2, r'$8\pm \Delta 0.1$ GeV', color='red', size=13)
  # plt.xlim([0., 10.])
  # plt.ylim([0., 0.01])
...
#+RESULTS:
:RESULTS:
[[file:./.ob-jupyter/9c2fdca15f69e21af08ec1f993ec44e06b4cb1aa.png]]
:END:
