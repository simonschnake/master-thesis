...
#+BEGIN_SRC ipython :session :results raw drawer :exports none :eval no-export
  ...
  n = 20
  y_f, mu_f, sigma_f = sliced_statistics(y_true[:28000] , y_fit[:28000:], n) 
  y_nn, mu_nn, sigma_nn = sliced_statistics(y_true[:28000:] , y_pred[:28000:], n) 
  ...
  ax.plot(y_f, sigma_f, '.', color='#1f77b4')
  ax.plot(y_nn, sigma_nn, 'k.')
