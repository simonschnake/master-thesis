...
:RESULTS:
# Out[31]:
[[file:./obipy-resources/Jocaiu.png]]
:END:
...
:RESULTS:
# Out[37]:
[[file:./obipy-resources/UIL56p.png]]
:END:
...
:RESULTS:
# Out[34]:
[[file:./obipy-resources/sYfZ9M.png]]
:END:
...
:RESULTS:
# Out[35]:
[[file:./obipy-resources/ppI9Zp.png]]
:END:
...
:RESULTS:
# Out[49]:
[[file:./obipy-resources/loPeA8.png]]
:END:
...
#+BEGIN_SRC ipython :session :results raw drawer :exports none :eval no-export
  ...
  ax.spines["top"].set_visible(False)
  ax.spines["right"].set_visible(False)
  ax.spines[p"bottom"].set_visible(False)
...
:RESULTS:
# Out[50]:
[[file:./obipy-resources/CKKHhz.png]]
:END:
...
:RESULTS:
# Out[52]:
[[file:./obipy-resources/UUXWUD.png]]
:END:
...
:RESULTS:
# Out[53]:
[[file:./obipy-resources/qc3q5w.png]]
:END:
...
:RESULTS:
# Out[55]:
[[file:./obipy-resources/xpn4Ok.png]]
:END:
...
:RESULTS:
# Out[59]:
[[file:./obipy-resources/EqPVCx.png]]
:END:
