...
%Figure \todo{bild einfügen} shows how the different algorithms differ from each other.
...
\todo{simulationsbild überarbeiten, red green?}
\begin{figure}[H]
  \centering
...
\todo{training validation test split satz}
\todo{training hyperparameters}
...
\todo{activation function erklären, warum linear letzte, wie bin ich zu der struktur gekommen}
\todo{inputkanäle}
