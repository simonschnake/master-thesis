...
\begin{figure}[hbtp]
  ...
  \begin{tikzpicture}[>=latex']
    ...
    (like) edge (achiev);
  \end{tikzpicture}
  \caption{The Graph displayes the structure of the analysis
...
Instead of hadrons, electrons are simulated here since their energy
response is expected to be linear and basic properties of the DNN
approach can be studied more easily. The reconstruction of pions and
jets is the task of further studies.
...
\begin{figure}[hbtp]%
  ...
  \caption{The energy distribution of the incoming particles}%
  \label{fig:e-distr}%
\end{figure}

In the following figures the complete spectrum is shown on the left,
while on the right two samples from the distribution are shown. In
this case only values in a range of $2\pm 0.1$ and $8 \pm 0.1$ GeV are
shown.
...
\begin{figure}[hbtp]%
  ...
  \caption{Distribution of summed traces in the calorimeter cells}%
  \label{fig:n-distri}%
\end{figure}
...
\begin{figure}[hbtp]
  ...
  \end{tikzpicture}
  \caption{The schematic training sequence of the three training steps.}
    \label{fig:jet-trainings-setup}
\end{figure}

The results will be labeled as MSE, 1st and 2nd. Here MSE means that
the results are obtained after training with mean squared error as a
loss function. 1st and 2nd denotes the two subsequent training results
with the loss function described below.
...
\((200, 4)\) input space are flattened into a (800, 1) space. In the
...
% LocalWords:  hadronic Geant calorimeters Hadron ECAL CMS absorber
% LocalWords:  convolutional backpropagating scintillator
